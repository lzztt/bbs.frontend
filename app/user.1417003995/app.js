...
userApp.config(['$routeProvider', function ($routeProvider) {
      $routeProvider
          .when('/mailbox/:folder', {
             templateUrl: '/app/user.1417003995/mailbox.tpl.html',
             controller: 'MailboxCtrl'
          })
          .when('/pm/:mid', {
             templateUrl: '/app/user.1417003995/message.tpl.html',
             controller: 'MessageCtrl'
          })
          .when('/bookmark', {
             templateUrl: '/app/user.1417003995/bookmark.tpl.html',
             controller: 'BookmarkCtrl'
          })
          .when('/profile', {
             templateUrl: '/app/user.1417003995/profile.tpl.html',
             controller: 'ProfileCtrl'
          })
          .when('/login', {
             controller: 'LoginCtrl',
             templateUrl: '/app/user.1417003995/login.tpl.html'
          })
          .when('/logout', {
