...
userApp.config(['$routeProvider', function ($routeProvider) {
      $routeProvider
          .when('/mailbox/:folder', {
             templateUrl: '/app/user.1416976761/mailbox.tpl.html',
             controller: 'MailboxCtrl'
          })
          .when('/pm/:mid', {
             templateUrl: '/app/user.1416976761/message.tpl.html',
             controller: 'MessageCtrl'
          })
          .when('/bookmark', {
             templateUrl: '/app/user.1416976761/bookmark.tpl.html',
             controller: 'BookmarkCtrl'
          })
          .when('/profile', {
             templateUrl: '/app/user.1416976761/profile.tpl.html',
             controller: 'ProfileCtrl'
          })
          .when('/login', {
             controller: 'LoginCtrl',
             templateUrl: '/app/user.1416976761/login.tpl.html'
          })
          .when('/logout', {
